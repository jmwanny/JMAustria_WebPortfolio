  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center pt-20 pb-16 px-5 sm:px-8 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto w-full">
        ...
        <div className="flex flex-col gap-[120px] lg:hidden">
          ...
          <div className="flex flex-col gap-5 text-center items-center">
            ...
            <div>
              ...
              <h1 className="font-display font-extrabold leading-[0.95] text-4xl sm:text-5xl tracking-tight">
                JUAN MIGUEL
                <br />
            ...
            <div className="h-7 font-mono text-sm text-ink2">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
               ...
               <a href="Docs/JM_Austria_CV_Coming_Soon.pdf"
                download
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-xl bg-cyan text-ink px-5 py-2.5 text-sm font-bold hover:bg-cyan-soft transition-colors"
              >
                <Download size={15} /> Download CV
              </a>
              
              <a  href="#projects"
                className="inline-flex items-center gap-2 rounded-xl border border-line px-5 py-2.5 text-sm font-semibold text-ink2 hover:text-white hover:border-cyan/50 transition-colors"
              >
                ...
                {socials.map((s) => {
                  ...
                  return (
                    ...
                    <a  key={s.name}
                      ...
                      rel="noreferrer"
                      aria-label={s.name}
                      className="w-9 h-9 rounded-xl border border-line bg-surface/60 grid place-items-center text-ink2 hover:text-cyan hover:border-cyan/50 hover:-translate-y-0.5 transition-all"
                    >
                      <Icon size={15} />
                    </a>
                  );
          ...
          {/* Code card — mobile */}
          <div className="relative pt-14 mx-auto w-full max-w-sm sm:max-w-md">
            <Avatar />
            ...
            <div className="relative rounded-2xl border border-line bg-[#0c1119] shadow-2xl overflow-hidden">
              ...
              <pre className="p-4 sm:p-5 font-mono text-[11px] sm:text-[12.5px] leading-relaxed overflow-x-auto">
                <code>
        ...
        <div className="hidden lg:grid lg:grid-cols-[1.05fr_0.95fr] gap-16 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              <p className="font-mono text-sm text-ink2 mb-2">Hi, I'm</p>
              <h1 className="font-display font-extrabold leading-[0.95] text-5xl sm:text-6xl md:text-7xl tracking-tight">
                JUAN MIGUEL
                <br />
                <span className="text-gradient">AUSTRIA</span>
              </h1>
            ...
            <div className="h-7 font-mono text-sm sm:text-base text-ink2">
              <span className="text-ink">{typed}</span>
              <span className="inline-block w-[2px] h-4 bg-cyan ml-1 align-middle animate-blink" />
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 mt-2">
              ...
              <a href="Docs/JM_Austria_CV_Coming_Soon.pdf"
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-xl bg-cyan text-ink px-5 py-3 text-sm font-bold hover:bg-cyan-soft transition-colors"
              >
                <Download size={16} /> Download CV
              </a>
              
               <a href="#projects"
                className="inline-flex items-center gap-2 rounded-xl border border-line px-5 py-3 text-sm font-semibold text-ink2 hover:text-white hover:border-cyan/50 transition-colors"
              >
                ...
                {socials.map((s) => {
                  ...
                  return (
                     ...
                     <a key={s.name}
                      ...
                      rel="noreferrer"
                      aria-label={s.name}
                      className="w-10 h-10 rounded-xl border border-line bg-surface/60 grid place-items-center text-ink2 hover:text-cyan hover:border-cyan/50 hover:-translate-y-0.5 transition-all"
                    >
                      <Icon size={16} />
                    </a>
                  );
          ...
          {/* Right — code card */}
          <div className="relative animate-floatY pt-14">
            <Avatar />
            <div className="absolute -inset-3 rounded-3xl blur-2xl" style={{ background: "linear-gradient(135deg, rgba(0,234,255,0.2), transparent, rgba(255,180,84,0.2))" }} />
            <div className="relative rounded-2xl border border-line bg-[#0c1119] shadow-2xl overflow-hidden">
              <div className="flex items-center gap-2 px-4 py-3 border-b border-line bg-panel/60">
              ...
              <pre className="p-5 sm:p-6 font-mono text-[12.5px] sm:text-[13.5px] leading-relaxed overflow-x-auto">
                <code>
                  <span className="text-[#8a97a8]">// profile summary</span>{"\n"}
                  <span className="text-[#c084fc]">const</span> <span className="text-[#5ff2ff]">developer</span> = {"{"}
                  {"\n"}  name: <span className="text-[#a5f3fc]">"Juan Miguel Austria"</span>,
            ...
            <div className="absolute -bottom-6 -left-6 flex items-center gap-2 rounded-xl border border-line bg-panel px-4 py-2.5 font-mono text-[11px] shadow-xl">
